...
TEST(isValidURLRequest, ValidInput)
{
    ...
    result = isValidURLRequest("POST www.example.com");
...
TEST(isValidURLRequest, ValidInput1)
{
    ...
    result = isValidURLRequest("POST www.example34278.com");
    EXPECT_EQ("POST", result.first);
    ...
    result = isValidURLRequest("GET www.example4637example.com");
    EXPECT_EQ("GET", result.first);
...
TEST(isValidURLRequest, ValidInput2)
{
    ...
    result = isValidURLRequest("POST www.fndkjfnkjdvsjvdkvnldnvnsckllkbkjexample34278.com");
    EXPECT_EQ("POST", result.first);
...
{
    EXPECT_EQ("", isValidURLRequest("3 www.example.com").first);
...
{
    EXPECT_EQ("", isValidURLRequest("www.example.com").first);
    EXPECT_EQ("", isValidURLRequest("www.example.com 2").first);
    EXPECT_EQ("", isValidURLRequest("1").first);
    EXPECT_EQ("", isValidURLRequest("1 www.com").first);
}

// different spaces between the argumnets
TEST(isValidURLRequest, inValidInput2)
{
    EXPECT_EQ("", isValidURLRequest("GETwww.example.com").first);
    std::pair<std::string, std::string> result = isValidURLRequest("POST        www.example.com");
    EXPECT_EQ("POST", result.first);
    EXPECT_EQ("www.example.com", result.second);
}
...
{
    EXPECT_EQ("", isValidURLRequest("POST w ww.example.com").first);
    EXPECT_EQ("", isValidURLRequest("POST ww w.example.com").first);
    EXPECT_EQ("", isValidURLRequest("GET www .example.com").first);
    EXPECT_EQ("", isValidURLRequest("GET www. example.com").first);
    EXPECT_EQ("", isValidURLRequest("GET www.exam ple.com").first);
    EXPECT_EQ("", isValidURLRequest("GET www.example .com").first);
    EXPECT_EQ("", isValidURLRequest("POST www.example. com").first);
    EXPECT_EQ("", isValidURLRequest("POST www.example.c om").first);
...
{
    EXPECT_EQ("", isValidURLRequest("GET,www.example.com").first);
    EXPECT_EQ("", isValidURLRequest("GET w1ww.example.com").first);
    EXPECT_EQ("", isValidURLRequest("POST www,example.com").first);
    EXPECT_EQ("", isValidURLRequest("POST www.example:com").first);
